    ...
    <div class="navbar menu">
      ...
      <div class="nav-collapse collapse">
        <ul class="nav">
          ...
          <li><a href="cinema.php" class="menu-ent">ENTRETENIMENTO</b></a></li>
          ...
          <li><a href="multimidia.php" class="menu-mult mult-ativo">MULTIMIDIA</a>
...
<div class="container marketing">
  <div class="row">
  	<div class="span12" align="center" style="margin:20px">
    	<img src="img/corpo-doltv.jpg" width="940" class="margin-res" />
    </div>
  <!-- 
    <div class="span4">
      <h2>Heading</h2>
